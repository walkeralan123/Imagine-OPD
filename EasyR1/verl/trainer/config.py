...
class DataConfig:
    ...
    """store raw chat messages in batch for re-tokenization (needed for OPD)"""
...
class AlgorithmConfig:
    ...
    """enable multimodal context distillation (OPD)"""
    teacher_system_prompt: Optional[str] = None
    """file path to teacher system prompt for OPD (avoids YAML parsing issues with special chars)"""
    teacher_use_ground_truth: bool = True
    """append the dataset ground-truth answer to the teacher prompt for OPD"""
