...
class RayPPOTrainer:
    ...
    def __init__(
        ...
        # Multimodal context distillation (OPD) config
        ...
        self.teacher_use_ground_truth = config.algorithm.teacher_use_ground_truth
        ...
        if self.use_mm_context_distillation:
            ...
            # OPD requires reference policy for teacher log probs
            self.use_reference_policy = True
                    ...
                    with timer("ref", timing_raw):
                        ...
                        if self.use_mm_context_distillation:
                            ...
                            batch = prepare_mm_context_distillation_inputs(
                                ...
                                include_ground_truth=self.teacher_use_ground_truth,
                                min_pixels=self.config.data.min_pixels,
                                max_pixels=self.config.data.max_pixels,
                            )
